...
namespace Tafseel.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260801183909_MarketplaceTeacherServicesRelease2")]
    partial class MarketplaceTeacherServicesRelease2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tafseel.Domain.Catalog.QualificationAssignmentResource", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("QualificationAssignmentId", "DisplayOrder");

                    b.ToTable("QualificationAssignmentResources", t =>
                        {
                            t.HasCheckConstraint("CK_QualificationAssignmentResources_Size", "[SizeBytes] >= 0");

                            t.HasCheckConstraint("CK_QualificationAssignmentResources_Type", "[ResourceType] BETWEEN 0 AND 1");
                        });
                });

            modelBuilder.Entity("Tafseel.Domain.Finance.Coupon", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("Coupons", t =>
                        {
                            t.HasCheckConstraint("CK_Coupons_Code", "[Code] <> ''");

                            t.HasCheckConstraint("CK_Coupons_DiscountType", "[DiscountType] BETWEEN 0 AND 1");

                            t.HasCheckConstraint("CK_Coupons_DiscountValue", "[DiscountValue] > 0");
                        });
                });

            modelBuilder.Entity("Tafseel.Domain.Finance.CouponRedemption", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("CouponRedemptions", t =>
                        {
                            t.HasCheckConstraint("CK_CouponRedemptions_DiscountAmount", "[DiscountAmount] > 0");

                            t.HasCheckConstraint("CK_CouponRedemptions_Target", "([OrderId] IS NOT NULL AND [LiveSessionBookingId] IS NULL) OR ([OrderId] IS NULL AND [LiveSessionBookingId] IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("Tafseel.Domain.Marketplace.TeacherTeachingSample", b =>
                {
                    ...
                    b.HasIndex("SourceDemoSubmissionId")
                        .IsUnique()
                        .HasFilter("[SourceDemoSubmissionId] IS NOT NULL");
            ...
            modelBuilder.Entity("Tafseel.Domain.Students.StudentLearningPreference", b =>
                {
                    b.Property<string>("UserId")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<string>("ExplanationStyle")
                        .HasMaxLength(32)
                        .HasColumnType("nvarchar(32)");

                    b.Property<Guid?>("PreferredTeachingLanguageId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PreferredTeachingLanguageId");

                    b.ToTable("StudentLearningPreferences", t =>
                        {
                            t.HasCheckConstraint("CK_StudentLearningPreferences_ExplanationStyle", "[ExplanationStyle] IS NULL OR [ExplanationStyle] IN ('step_by_step','short_direct','detailed','visual','exam_focused','practice_focused')");
                        });
                });
            ...
            modelBuilder.Entity("Tafseel.Domain.TeacherApplications.TeacherApplication", b =>
                {
                    ...
                    b.Property<Guid?>("LatestDemoSubmissionId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Tafseel.Domain.TeacherApplications.TeacherDemoSubmission", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("QualificationAssignmentId");

                    b.HasIndex("SubjectId");

                    b.HasIndex("TeacherId");

                    b.HasIndex("TeacherApplicationId", "SubmissionVersion")
                        .IsUnique();

                    b.ToTable("TeacherDemoSubmissions", t =>
                        {
                            t.HasCheckConstraint("CK_TeacherDemoSubmissions_Duration", "[DurationSeconds] BETWEEN 1 AND 600");

                            t.HasCheckConstraint("CK_TeacherDemoSubmissions_Size", "[SizeBytes] > 0");

                            t.HasCheckConstraint("CK_TeacherDemoSubmissions_Version", "[SubmissionVersion] > 0");
                        });
                });
            ...
            modelBuilder.Entity("Tafseel.Domain.TeacherApplications.TeacherSubjectQualification", b =>
                {
                    ...
                    b.ToTable("TeacherSubjectQualifications", t =>
                        {
                            t.HasCheckConstraint("CK_TeacherSubjectQualifications_Status", "[Status] BETWEEN 0 AND 1");
                        });
                });
            ...
            modelBuilder.Entity("Tafseel.Domain.Catalog.QualificationTopic", b =>
                {
                    ...
                    b.Property<string>("EvaluationGuidanceAr")
                        .IsRequired()
                        .HasMaxLength(4000)
                        .HasColumnType("nvarchar(4000)");

                    b.Property<int>("ExpectedVideoSeconds")
                        .HasColumnType("int");
                    ...
                    b.ToTable("QualificationTopics", t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_QualificationTopics_DisplayOrder", "[DisplayOrder] BETWEEN 0 AND 10000");

                            t.HasCheckConstraint("CK_QualificationTopics_Duration", "[MinVideoSeconds] BETWEEN 30 AND [ExpectedVideoSeconds] AND [ExpectedVideoSeconds] <= [MaxVideoSeconds]");
            ...
            modelBuilder.Entity("Tafseel.Domain.Catalog.QualificationAssignmentResource", b =>
                {
                    b.HasOne("Tafseel.Domain.Catalog.QualificationTopic", null)
                        .WithMany()
                        .HasForeignKey("QualificationAssignmentId")
            ...
            modelBuilder.Entity("Tafseel.Domain.Students.StudentLearningPreference", b =>
                {
                    b.HasOne("Tafseel.Domain.Catalog.TeachingLanguage", null)
                        .WithMany()
                        .HasForeignKey("PreferredTeachingLanguageId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Tafseel.Infrastructure.Identity.ApplicationUser", null)
                        .WithOne()
                        .HasForeignKey("Tafseel.Domain.Students.StudentLearningPreference", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
